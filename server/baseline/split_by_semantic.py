...
def semantic_split(input_path, output_dir, buffer_size=1, threshold_percentile=90):
    """
    ...
    output_path = os.path.join(output_dir, f"baseline_split_b:{buffer_size}_p:{threshold_percentile}.json")
